    ...
    <ul class="nav nav-secondary">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="maps">
                <ul class="nav nav-collapse">
                    <li>
                        <a href="<?php echo e(route('shipping_units.index')); ?>">
                            <span class="sub-item">Danh sách đơn vị vận chuyển</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('shipping_units.create')); ?>">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="provinces">
                <ul class="nav nav-collapse">
                    <li>
                        <a href="<?php echo e(route('provinces.index')); ?>">
                            <span class="sub-item">Danh sách tỉnh thành</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('provinces.create')); ?>">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="dis">
                <ul class="nav nav-collapse">
                    <li>
                        <a href="<?php echo e(route('districts.index')); ?>">
                            <span class="sub-item">Danh sách quận/huyện</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('districts.create')); ?>">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="was">
                <ul class="nav nav-collapse">
                    <li>
                        <a href="<?php echo e(route('wards.index')); ?>">
                            <span class="sub-item">Danh sách quận/huyện</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('wards.create')); ?>">
                            <span class="sub-item">Thêm quận/huyện</span>
                        </a>
                    </li>
                </ul>
